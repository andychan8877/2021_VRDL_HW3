...
#             for j in range(len(pictDat[i]['height'])):
                ...
                figure = dict(image_id=str(img_id).tolist(), bbox=figure_bbox.tolist(), score=str(r['scores'][i]).tolist(), category_id=str(r['class_ids'][i]).tolist(), segmentation=submission[0][i].tolist())
